...
def print_results(results_dic, results_stats_dic, model, 
    ...
    for key in results_stats_dic.keys():
        ...
        if key[0] == 'p':
                if key == 'pct_correct_notdogs':
                        print("Pct Corr NOTdog: {:5.1f}".format(results_stats_dic['pct_correct_notdogs']))
                if key == "pct_correct_dogs":
                        print("Pct Corr dog: {:5.1f}".format(results_stats_dic['pct_correct_dogs']))
                if key == 'pct_correct_breed':
                        print("Pct Corr Breed: {:5.1f}".format(results_stats_dic['pct_correct_breed']))
                if key == 'pct_match':
                        print("Pct Match labels: {:5.1f}".format(results_stats_dic['pct_match']))
    ...
    if (print_incorrect_dogs and 
        ...
        for list_val in results_dic.values():
            ...
            #          is accessed by list_val and the value is a list
            #          so list_val[idx] - where idx represents the 
            #          index value of the list and can have values 0-4.
            #
            # Pet Image Label is a Dog - Classified as NOT-A-DOG -OR- 
            # Pet Image Label is NOT-a-Dog - Classified as a-DOG
            if (list_val[3] == 1 and list_val[4] == 0):
                print("Pet Image Label:{} is a Dog - Classified as :{} NOT-A-DOG".format(list_val[0],list_val[1]))
            if (list_val[3] == 0 and list_val[4] == 1):
                print("Pet Image Label:{} is NOT-a-Dog - Classified as :{} a-DOG".format(list_val[0],list_val[1]))
    ...
    if (print_incorrect_breed and 
        ...
        for list_val in results_dic.values():
            ...
            if ( sum(list_val[3:]) == 2 and
                list_val[2] == 0 ):
                print("Real: {:>26}   Classifier: {:>30}".format(list_val[0],
                                                          list_val[1]))
